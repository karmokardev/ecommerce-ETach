...
export default function EditPurchase({ purchase, suppliers, warehouses, productVariants }: EditPurchaseProps) {
    const { data, setData, put, processing, errors } = useForm({
        invoice_no: purchase.invoice_no,
        supplier_id: purchase.supplier_id ? purchase.supplier_id.toString() : '',
        warehouse_id: purchase.warehouse_id ? purchase.warehouse_id.toString() : '',
            ...
            <div className="p-6">
                <div className="max-w-6xl mx-auto">
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-2xl font-bold dark:text-white">Edit Purchase</h1>
                    </div>
