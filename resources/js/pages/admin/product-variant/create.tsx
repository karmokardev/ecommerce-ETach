...
export default function CreateProductVariant({ products }: CreateProductVariantProps) {
            ...
            <div className="p-6">
                <div className="max-w-4xl mx-auto">
                    <div className="flex justify-between items-center mb-6">
                        <h1 className="text-2xl font-bold dark:text-white">Create Product Variant</h1>
                    </div>
