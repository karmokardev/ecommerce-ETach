...
export default function CreateAttributeValue({ attribute }: CreateAttributeValueProps) {
    ...
    return (
        <>
            <Head title={`Create Attribute Value: ${attribute.name}`} />
            <div className="p-6">
                    ...
                    <div className="flex justify-between items-center mb-6">
                        <div className="flex items-center gap-4">
                            ...
                            <h1 className="text-2xl font-bold dark:text-white">
                                Create Attribute Value: <span className="text-blue-600">{attribute.name}</span>
                            </h1>
                        </div>
                    </div>
                    ...
                    <div className="bg-white dark:bg-neutral-900 rounded-lg shadow-sm border dark:border-neutral-800 p-6">
                        <form onSubmit={handleSubmit}>
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <input
                                        ...
                                        className="w-full px-3 py-2 border border-gray-300 dark:border-neutral-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent bg-white dark:bg-neutral-800 text-gray-900 dark:text-gray-100"
                                        placeholder="e.g., small (auto-generated if empty)"
                                    />
                                    {errors.slug && (
                            ...
                            <div className="flex items-center gap-4 pt-6">
                                ...
                                >
                                    {processing ? 'Creating...' : 'Create Attribute Value'}
                                </button>
                                <a
