...
export default function CreateShippingMethod() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        router.post('/shipping/methods', formData, {
            onSuccess: () => {
    ...
    return (
        <>
            ...
            <div className="p-6">
                ...
                <div className="mb-6">
                    <h1 className="text-2xl font-bold dark:text-white">Create Shipping Method</h1>
                    <p className="text-gray-500 dark:text-gray-400 mt-1">Add a new shipping method to your store</p>
                </div>
