...
export default function EditProduct({ product, categories, brands, attributes }: EditProductProps) {
                                ...
                                <div className="md:col-span-2">
                                    ...
                                    <div className="mt-1 flex justify-center px-6 pt-5 pb-6 border-2 border-gray-300 dark:border-neutral-700 border-dashed rounded-lg hover:border-blue-500 dark:hover:border-blue-500 transition-colors">
                                        <div className="space-y-1 text-center">
                                            ...
                                            ) : product.thumbnail && !data.remove_thumbnail ? (
                                                <div className="relative">
                                                    <img
                                ...
                                {product.images && product.images.length > 0 && (
                                    <div className="md:col-span-2">
                                        ...
                                        <div className="grid grid-cols-4 gap-4">
                                            {product.images
                                                .filter(img => !data.remove_images.includes(img.id))
                                                .map((image) => (
